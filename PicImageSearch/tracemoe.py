...
class TraceMoeNorm:
    ...
    def _preview_video(self, mute=False):
        ...
        Params Keys
        -----------
        :param mute: (boolean) Whether the preview video is muted
        :return: preview video url address
        """
    ...
    def download_image(self, filename='image.png'):
        ...
        Params Keys
        -----------
        :param filename: (str) rename file
        """
...
class TraceMoe:
    ...
    Params Keys
    -----------
    :param mute: (boolean) Whether the preview video is muted (default is not muted)
    ...
    def search(self, url, Filter=0):
        ...
        Params Keys
        -----------
        :param url: (str) network address or local
