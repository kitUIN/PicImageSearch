...
logger.info(res.raw[
                4])  # <NormGoogle(title=["The Strongest Dull Prince's Secret Battle for the Throne ..."], urls=['https://kiryuu.co/the-strongest-dull-princes-secret-battle-for-the-throne-chapter-3-bahasa-indonesia/'], thumbnail=['No directable url'])>
logger.info(res.raw[4].thumbnail)  # No directable url
logger.info(res.raw[4].title)  # The Strongest Dull Prince's Secret Battle for the Throne ...
logger.info(res.raw[
                4].url)  # https://kiryuu.co/the-strongest-dull-princes-secret-battle-for-the-throne-chapter-3-bahasa-indonesia/
