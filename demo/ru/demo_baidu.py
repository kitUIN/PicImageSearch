...
from src import BaiDu, Network
from src.model import BaiDuResponse
from src.sync import BaiDu as BaiDuSync
...
def show_result(resp: BaiDuResponse) -> None:
    ...
    # logger.info(resp.raw[0].similarity)  # устарело
    # logger.info(resp.raw[0].title)  # устарело
